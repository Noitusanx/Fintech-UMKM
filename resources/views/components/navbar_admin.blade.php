        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ url('/') }}" class="flex">
                    <h1 class="navbar-title mt-3mb-5 ml-2 dark:text-gray-200 text-gray-900">Fintech</h1>
                </a>
            </div>
            <div class="flex items-center">
                ...
                <div id="tooltip-toggle" role="tooltip"
                    ...
                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(785.5px, 60px, 0px);"
                    data-popper-placement="bottom">
                    Toggle dark mode

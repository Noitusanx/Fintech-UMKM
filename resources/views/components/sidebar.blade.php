<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform pt-6 -translate-x-fullborder-r sm:translate-x-0 bg-gray-800 border-gray-700"
    aria-label="Sidebar">

    <div class="h-full px-3 pb-4 overflow-y-autobg-gray-800">
        <a href="{{ url('/') }}">
            <h1 class="navbar-title text-white pl-4">Fintech</h1>
        </a>
        <ul class="space-y-2 font-medium pt-8">
            ...
            <li>
                <a href="{{ url('/finansial') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Finansial</span>
                </a>
            </li>
        </ul>
    </div>

            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div>
                    ...
                    <select id="kategori" name="kategori"
                        class="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    ...
                    <div class="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden items-center">
                        <div class="px-4 py-6">
                            ...
                            <div class="flex items-center justify-center">
                                <div class="w-full">
                                    <label for="upload"
                                        class="w-full text-white dark:bg-gray-700 hover:opacity-90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center justify-center mr-2 mb-2 cursor-pointer">

...
<div class="px-4 pb-4 mt-6">
    <section class="font-poppins flex justify-end">
                            ...
                            <div class="px-4 py-6">
                                <div id="image-preview"
                                    ...
                                    <label for="upload" class="cursor-pointer">
                                        ...
                                        <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Unggah Gambar
                                        </h5>
                                        <p class="font-normal text-sm text-gray-400 md:px-6">Ukuran foto seharusnya
                                            kurang
